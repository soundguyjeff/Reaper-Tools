-- REAPER Lua Script: Custom Nudge Left by 6 Frames Moving Entire Selection
...
-- Move entire selection left by 6 frames
function nudgeLeftBy6Frames()
    ...
    -- Move the edit cursor left by 6 frames if no item is selected
